...
public class EggStageAttributesBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class , EggStageAttributesCustomizer.class ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_active] = new PropertyDescriptor ( "active", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "isActive", "setActive" ); // NOI18N
            properties[PROPERTY_alive] = new PropertyDescriptor ( "alive", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "isAlive", "setAlive" ); // NOI18N
            properties[PROPERTY_arrayList] = new PropertyDescriptor ( "arrayList", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "getArrayList", null ); // NOI18N
            properties[PROPERTY_attributes] = new PropertyDescriptor ( "attributes", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "getAttributes", null ); // NOI18N
            properties[PROPERTY_classes] = new PropertyDescriptor ( "classes", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "getClasses", null ); // NOI18N
            properties[PROPERTY_CSV] = new PropertyDescriptor ( "CSV", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "getCSV", null ); // NOI18N
            properties[PROPERTY_CSVHeader] = new PropertyDescriptor ( "CSVHeader", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "getCSVHeader", null ); // NOI18N
            properties[PROPERTY_CSVHeaderShortNames] = new PropertyDescriptor ( "CSVHeaderShortNames", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "getCSVHeaderShortNames", null ); // NOI18N
            properties[PROPERTY_geometry] = new PropertyDescriptor ( "geometry", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "getGeometry", "setGeometry" ); // NOI18N
            properties[PROPERTY_ID] = new PropertyDescriptor ( "ID", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "getID", null ); // NOI18N
            properties[PROPERTY_keys] = new PropertyDescriptor ( "keys", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "getKeys", null ); // NOI18N
            properties[PROPERTY_shortNames] = new PropertyDescriptor ( "shortNames", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "getShortNames", null ); // NOI18N
            properties[PROPERTY_startTime] = new PropertyDescriptor ( "startTime", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "getStartTime", "setStartTime" ); // NOI18N
            properties[PROPERTY_typeName] = new PropertyDescriptor ( "typeName", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "getTypeName", null ); // NOI18N
            properties[PROPERTY_values] = new PropertyDescriptor ( "values", wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, null, "setValues" ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_clone0] = new MethodDescriptor(wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class.getMethod("clone", new Class[] {})); // NOI18N
            methods[METHOD_clone0].setDisplayName ( "" );
            methods[METHOD_createInstance1] = new MethodDescriptor(wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class.getMethod("createInstance", new Class[] {java.lang.String[].class})); // NOI18N
            ...
            methods[METHOD_getValueAsString12] = new MethodDescriptor(wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class.getMethod("getValueAsString", new Class[] {java.lang.String.class})); // NOI18N
            ...
            methods[METHOD_setValueFromString18] = new MethodDescriptor(wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes.class.getMethod("setValueFromString", new Class[] {java.lang.String.class, java.lang.String.class})); // NOI18N
