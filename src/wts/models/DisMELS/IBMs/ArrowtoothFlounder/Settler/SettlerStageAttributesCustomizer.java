/*
 * SettlerStageAttributesCustomizer.java
 *
 ...
 */
public class SettlerStageAttributesCustomizer extends AttributesCustomizer {

    private SettlerStageAttributes attributes = null;
    
    /**
     * Creates new customizer LarvaStageAttributesCustomizer
     */
    public SettlerStageAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof SettlerStageAttributes) {
            setAttributes((SettlerStageAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof SettlerStageAttributes) {
            attributes = (SettlerStageAttributes) newAtts;
