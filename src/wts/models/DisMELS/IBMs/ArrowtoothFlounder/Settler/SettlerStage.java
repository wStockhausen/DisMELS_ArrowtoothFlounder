...
import wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStage;
...
public class SettlerStage extends AbstractLHS {
    ...
    public static final String attributesClass = SettlerStageAttributes.class.getName();
    /* Class for parameters */
    public static final String parametersClass = SettlerStageParameters.class.getName();
...
//            wts.models.DisMELS.IBMs.Arrowtooth.EggStage.EggStagePointFT.class.getName();
    ...
    public static final String[] nextLHSClasses = new String[]{SettlerStage.class.getName(),
                                                               BenthicJuvenileStage.class.getName()};
    ...
    protected SettlerStageAttributes atts = null;
    /* life stage parameters object */
    protected SettlerStageParameters params = null;
    ...
    /** logger for class */
    private static final Logger logger = Logger.getLogger(SettlerStage.class.getName());
     ...
     * DO NOT DELETE THIS CONSTRUCTOR!!
     */
    public SettlerStage(String typeName) 
                throws InstantiationException, IllegalAccessException {
        super(typeName);
        atts = new SettlerStageAttributes(typeName);
        ...
        params = (SettlerStageParameters) LHS_Factory.createParameters(typeName);
     ...
     */
    @Override
    public SettlerStage createInstance(String[] strv) 
                        throws InstantiationException, IllegalAccessException {
        LifeStageAttributesInterface theAtts = LHS_Factory.createAttributes(strv);
        SettlerStage lhs = createInstance(theAtts);
        return lhs;
    }
     ...
     */
    @Override
    public SettlerStage createInstance(LifeStageAttributesInterface theAtts)
                        throws InstantiationException, IllegalAccessException {
        SettlerStage lhs = null;
        if (theAtts instanceof SettlerStageAttributes) {
            lhs = new SettlerStage(theAtts.getTypeName());
     ...
     */
    @Override
    public SettlerStageAttributes getAttributes() {
        return atts;
    }
     ...
     */
    @Override
    public SettlerStageParameters getParameters() {
        return params;
    }
    ...
    public void setParameters(LifeStageParametersInterface newParams) {
        if (newParams instanceof SettlerStageParameters) {
            params = (SettlerStageParameters) newParams;
    ...
    private void setIBMFunctions(){
        fcnGrowth  = params.getSelectedIBMFunctionForCategory(SettlerStageParameters.FCAT_Growth);
        fcnMort    = params.getSelectedIBMFunctionForCategory(SettlerStageParameters.FCAT_Mortality);
        fcnVM      = params.getSelectedIBMFunctionForCategory(SettlerStageParameters.FCAT_VerticalMovement);
        fcnVV      = params.getSelectedIBMFunctionForCategory(SettlerStageParameters.FCAT_VerticalVelocity);
    }
    ...
    private void setParameterValues() {
        isSuperIndividual = 
                params.getValue(SettlerStageParameters.PARAM_isSuperIndividual,isSuperIndividual);
        horizRWP = 
                params.getValue(SettlerStageParameters.PARAM_horizRWP,horizRWP);
        initialSize = 
                params.getValue(SettlerStageParameters.PARAM_initialSize,initialSize);
        initialWeight = 
                params.getValue(SettlerStageParameters.PARAM_initialWeight,initialWeight);
        minStageDuration = 
                params.getValue(SettlerStageParameters.PARAM_minStageDuration,minStageDuration);
        maxStageDuration = 
                params.getValue(SettlerStageParameters.PARAM_maxStageDuration,maxStageDuration);
        minSettlementDepth = 
                params.getValue(SettlerStageParameters.PARAM_minSettlementDepth,minSettlementDepth);
        maxSettlementDepth = 
                params.getValue(SettlerStageParameters.PARAM_maxSettlementDepth,maxSettlementDepth);
        randomizeTransitions = 
                params.getValue(SettlerStageParameters.PARAM_randomizeTransitions,true);
    }
    ...
    @Override
    public Object clone() {
        SettlerStage clone = null;
        try {
            clone = (SettlerStage) super.clone();
...
//                if (xPos<0) xPos=xPos+360;
    ...
    protected void updateAttributes() {
        ...
        atts.setValue(SettlerStageAttributes.PROP_size,size);
        atts.setValue(SettlerStageAttributes.PROP_weight,weight);
        atts.setValue(SettlerStageAttributes.PROP_salinity,salinity);
        atts.setValue(SettlerStageAttributes.PROP_temperature,temperature);
    }
    ...
    protected void updateVariables() {
        ...
        size        = atts.getValue(SettlerStageAttributes.PROP_size,size);
        weight      = atts.getValue(SettlerStageAttributes.PROP_weight,weight);
        salinity    = atts.getValue(SettlerStageAttributes.PROP_salinity,salinity);
        temperature = atts.getValue(SettlerStageAttributes.PROP_temperature,temperature);
    }
