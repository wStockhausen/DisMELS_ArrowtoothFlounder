...
import wts.models.DisMELS.IBMs.ArrowtoothFlounder.EggStage.EggStageAttributes;
import wts.models.DisMELS.IBMs.ArrowtoothFlounder.Settler.SettlerStage;
...
public class LarvaStage extends AbstractLHS {
    ...
    public static final String attributesClass = LarvaStageAttributes.class.getName();
    /* Class for parameters */
    public static final String parametersClass = LarvaStageParameters.class.getName();
...
//            wts.models.DisMELS.IBMs.Arrowtooth.EggStage.EggStagePointFT.class.getName();
    ...
    public static final String[] nextLHSClasses = new String[]{LarvaStage.class.getName(),
                                                               SettlerStage.class.getName()};
    ...
    protected LarvaStageAttributes atts = null;
    /* life stage parameters object */
    protected LarvaStageParameters params = null;
     ...
     * DO NOT DELETE THIS CONSTRUCTOR!!
     */
    public LarvaStage(String typeName) 
                throws InstantiationException, IllegalAccessException {
        super(typeName);
        atts = new LarvaStageAttributes(typeName);
        ...
        params = (LarvaStageParameters) LHS_Factory.createParameters(typeName);
     ...
     */
    @Override
    public LarvaStage createInstance(String[] strv) 
                        throws InstantiationException, IllegalAccessException {
        LifeStageAttributesInterface theAtts = LHS_Factory.createAttributes(strv);
        LarvaStage lhs = createInstance(theAtts);
        return lhs;
    }
     ...
     */
    @Override
    public LarvaStage createInstance(LifeStageAttributesInterface theAtts)
                        throws InstantiationException, IllegalAccessException {
        LarvaStage lhs = null;
        if (theAtts instanceof LarvaStageAttributes) {
            lhs = new LarvaStage(theAtts.getTypeName());
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        ...
        if (newAtts instanceof EggStageAttributes) {
            ...
            akey = LarvaStageAttributes.PROP_size;    atts.setValue(akey, initialSize);
            akey = LarvaStageAttributes.PROP_weight;  atts.setValue(akey, initialWeight);
        }
     ...
     */
    @Override
    public LarvaStageParameters getParameters() {
        return params;
    }
    ...
    public void setParameters(LifeStageParametersInterface newParams) {
        if (newParams instanceof LarvaStageParameters) {
            params = (LarvaStageParameters) newParams;
    ...
    private void setIBMFunctions(){
        ...
        fcnVV      = params.getSelectedIBMFunctionForCategory(LarvaStageParameters.FCAT_VerticalVelocity);
    }
    ...
    private void setParameterValues() {
        isSuperIndividual = 
                params.getValue(LarvaStageParameters.PARAM_isSuperIndividual,isSuperIndividual);
        horizRWP = 
                params.getValue(LarvaStageParameters.PARAM_horizRWP,horizRWP);
        initialSize = 
                params.getValue(LarvaStageParameters.PARAM_initialSize,initialSize);
        initialWeight = 
                params.getValue(LarvaStageParameters.PARAM_initialWeight,initialWeight);
        minStageDuration = 
                params.getValue(LarvaStageParameters.PARAM_minStageDuration,minStageDuration);
        maxStageDuration = 
    ...
    @Override
    public Object clone() {
        LarvaStage clone = null;
        try {
            clone = (LarvaStage) super.clone();
...
//                if (xPos<0) xPos=xPos+360;
    ...
    protected void updateAttributes() {
        ...
        atts.setValue(LarvaStageAttributes.PROP_size,size);
        atts.setValue(LarvaStageAttributes.PROP_weight,weight);
        atts.setValue(LarvaStageAttributes.PROP_salinity,salinity);
        atts.setValue(LarvaStageAttributes.PROP_temperature,temperature);
    }
    ...
    protected void updateVariables() {
        ...
        size        = atts.getValue(LarvaStageAttributes.PROP_size,size);
        weight      = atts.getValue(LarvaStageAttributes.PROP_weight,weight);
        salinity    = atts.getValue(LarvaStageAttributes.PROP_salinity,salinity);
        temperature = atts.getValue(LarvaStageAttributes.PROP_temperature,temperature);
    }
