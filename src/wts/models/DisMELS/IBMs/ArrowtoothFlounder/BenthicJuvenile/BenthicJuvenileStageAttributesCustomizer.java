/*
 * BenthicJuvenileStageAttributesCustomizer.java
 *
 ...
 */
public class BenthicJuvenileStageAttributesCustomizer extends AttributesCustomizer {

    private BenthicJuvenileStageAttributes attributes = null;
    
    /**
     * Creates new customizer BenthicJuvenileStageAttributesCustomizer
     */
    public BenthicJuvenileStageAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof BenthicJuvenileStageAttributes) {
            setAttributes((BenthicJuvenileStageAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof BenthicJuvenileStageAttributes) {
            attributes = (BenthicJuvenileStageAttributes) newAtts;
