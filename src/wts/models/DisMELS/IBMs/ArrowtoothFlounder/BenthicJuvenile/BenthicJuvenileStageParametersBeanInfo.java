 ...
 */
public class BenthicJuvenileStageParametersBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_CSV] = new PropertyDescriptor ( "CSV", wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class, "getCSV", null ); // NOI18N
            properties[PROPERTY_CSVHeader] = new PropertyDescriptor ( "CSVHeader", wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class, "getCSVHeader", null ); // NOI18N
            properties[PROPERTY_IBMFunctionCategories] = new PropertyDescriptor ( "IBMFunctionCategories", wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class, "getIBMFunctionCategories", null ); // NOI18N
            properties[PROPERTY_IBMParameterNames] = new PropertyDescriptor ( "IBMParameterNames", wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class, "getIBMParameterNames", null ); // NOI18N
            properties[PROPERTY_keys] = new PropertyDescriptor ( "keys", wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class, "getKeys", null ); // NOI18N
            properties[PROPERTY_typeName] = new PropertyDescriptor ( "typeName", wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class, "getTypeName", "setTypeName" ); // NOI18N
        }
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_clone0] = new MethodDescriptor(wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class.getMethod("clone", new Class[] {})); // NOI18N
            methods[METHOD_clone0].setDisplayName ( "" );
            methods[METHOD_createInstance1] = new MethodDescriptor(wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class.getMethod("createInstance", new Class[] {java.lang.String[].class})); // NOI18N
            methods[METHOD_createInstance1].setDisplayName ( "" );
            methods[METHOD_getIBMFunction2] = new MethodDescriptor(wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class.getMethod("getIBMFunction", new Class[] {java.lang.String.class, java.lang.String.class})); // NOI18N
            methods[METHOD_getIBMFunction2].setDisplayName ( "" );
            methods[METHOD_getIBMFunctionNamesByCategory3] = new MethodDescriptor(wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class.getMethod("getIBMFunctionNamesByCategory", new Class[] {java.lang.String.class})); // NOI18N
            ...
            methods[METHOD_selectIBMFunctionForCategory16] = new MethodDescriptor(wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class.getMethod("selectIBMFunctionForCategory", new Class[] {java.lang.String.class, java.lang.String.class})); // NOI18N
            ...
            methods[METHOD_setValue22] = new MethodDescriptor(wts.models.DisMELS.IBMs.ArrowtoothFlounder.BenthicJuvenile.BenthicJuvenileStageParameters.class.getMethod("setValue", new Class[] {java.lang.String.class, java.lang.Object.class})); // NOI18N
